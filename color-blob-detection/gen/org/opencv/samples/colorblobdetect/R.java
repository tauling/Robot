...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a GridLayout.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #GridLayout_alignmentMode org.opencv.samples.colorblobdetect:alignmentMode}</code></td><td>
        When set to alignMargins, causes alignment to take place between the outer
        boundary of a view, as defined by its margins.</td></tr>
           <tr><td><code>{@link #GridLayout_columnCount org.opencv.samples.colorblobdetect:columnCount}</code></td><td> The maximum number of columns to create when automatically positioning children.</td></tr>
           <tr><td><code>{@link #GridLayout_columnOrderPreserved org.opencv.samples.colorblobdetect:columnOrderPreserved}</code></td><td>
        When set to true, forces column boundaries to appear in the same order
        as column indices.</td></tr>
           <tr><td><code>{@link #GridLayout_orientation org.opencv.samples.colorblobdetect:orientation}</code></td><td>
              support versions.</td></tr>
           <tr><td><code>{@link #GridLayout_rowCount org.opencv.samples.colorblobdetect:rowCount}</code></td><td> The maximum number of rows to create when automatically positioning children.</td></tr>
           <tr><td><code>{@link #GridLayout_rowOrderPreserved org.opencv.samples.colorblobdetect:rowOrderPreserved}</code></td><td>
        When set to true, forces row boundaries to appear in the same order
        as row indices.</td></tr>
           <tr><td><code>{@link #GridLayout_useDefaultMargins org.opencv.samples.colorblobdetect:useDefaultMargins}</code></td><td>
        When set to true, tells GridLayout to use default margins when none are specified
...
<tr><td><code>alignMargins</code></td><td>1</td><td>
          ...
          @attr name org.opencv.samples.colorblobdetect:alignmentMode
        */
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:columnCount
        */
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:columnOrderPreserved
        */
...
<tr><td><code>vertical</code></td><td>1</td><td> Defines a vertical widget. </td></tr>
          ...
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:orientation
        */
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:rowCount
        */
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:rowOrderPreserved
        */
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:useDefaultMargins
        */
        ...
        /** Attributes that can be used with a GridLayout_Layout.
           ...
           <tr><td><code>{@link #GridLayout_Layout_android_layout_width android:layout_width}</code></td><td>
              support versions.</td></tr>
           <tr><td><code>{@link #GridLayout_Layout_layout_column org.opencv.samples.colorblobdetect:layout_column}</code></td><td>
        The column boundary delimiting the left of the group of cells
        occupied by this view.</td></tr>
           <tr><td><code>{@link #GridLayout_Layout_layout_columnSpan org.opencv.samples.colorblobdetect:layout_columnSpan}</code></td><td>
        The column span: the difference between the right and left
        boundaries delimiting the group of cells occupied by this view.</td></tr>
           <tr><td><code>{@link #GridLayout_Layout_layout_columnWeight org.opencv.samples.colorblobdetect:layout_columnWeight}</code></td><td> The relative proportion of horizontal space that should be allocated to this view
        during excess space distribution.</td></tr>
           <tr><td><code>{@link #GridLayout_Layout_layout_gravity org.opencv.samples.colorblobdetect:layout_gravity}</code></td><td>
        Gravity specifies how a component should be placed in its group of cells.</td></tr>
           <tr><td><code>{@link #GridLayout_Layout_layout_row org.opencv.samples.colorblobdetect:layout_row}</code></td><td> END MarginLayout layoutparams 

        The row boundary delimiting the top of the group of cells
        occupied by this view.</td></tr>
           <tr><td><code>{@link #GridLayout_Layout_layout_rowSpan org.opencv.samples.colorblobdetect:layout_rowSpan}</code></td><td>
        The row span: the difference between the top and bottom
        boundaries delimiting the group of cells occupied by this view.</td></tr>
           <tr><td><code>{@link #GridLayout_Layout_layout_rowWeight org.opencv.samples.colorblobdetect:layout_rowWeight}</code></td><td> The relative proportion of vertical space that should be allocated to this view
        during excess space distribution.</td></tr>
           </table>
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:layout_column
        */
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:layout_columnSpan
        */
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:layout_columnWeight
        */
...
<tr><td><code>end</code></td><td>0x00800005</td><td> Push object to the end of its container, not changing its size. </td></tr>
          ...
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:layout_gravity
        */
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:layout_row
        */
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:layout_rowSpan
        */
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name org.opencv.samples.colorblobdetect:layout_rowWeight
        */
